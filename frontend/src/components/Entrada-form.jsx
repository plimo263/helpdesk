...
import { Body2, Caption, Subtitle2 } from "./tipografia";
...
const EntradaColorPicker = memo(
  ({
    ...
    return (
      <Stack alignItems="center" {...extraProps}>
        <Body2>{label}</Body2>
        <Sketch
          style={{ width: "100%" }}
          color={defaultValue}
                ...
                <Controller
                  ...
                  render={(propsController) => {
                    switch (type) {
                      ...
                      case "color_picker": // Permite a escolha de uma cor dentro da paleta de cores disponiveis
                        return (
                          <EntradaColorPicker
                            field={propsController.field}
                            {...ele}
