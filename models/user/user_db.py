...
class UserDB:
    ...
    def __set_attr_user(self, user_db: UserTable, name: str, email: str, password: str, agent: str, active: str, id_sector: int) -> UserTable:
    ...
    def get_all_rows(self) -> List[UserTable]:
        ''' Retorna uma lista de usuarios cadastrados no sistema.
    ...
    def delete_user(self, id: int):
        ''' Exclui o usuario do banco de dados, caso não consiga excluí-lo 
    ...
    def set_password(self, id: int, password: str):
        ...
        pode ser lançada caso o usuario nao exista ou aconteça algum erro no banco no momento de atualizar a senha.
